    ...
    <div className="Home">
      <div>
        ...
        <p>
          ...
          words correctly before the snake reaches the end of the stage screen.
          Track your progress and improve yuor typing skill!
        </p>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>
            Login or sign up to track your progress.You can continue as a guset
            too!
          </li>
